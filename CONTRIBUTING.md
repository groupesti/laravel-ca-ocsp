# Contributing to Laravel CA OCSP

Thank you for considering contributing to Laravel CA OCSP! This document provides guidelines and instructions for contributing.
...
- **Composer** 2.x
- **Git**
- **groupesti/laravel-ca-log** ^0.1 (structured logging)
- A working knowledge of [RFC 6960 (OCSP)](https://www.rfc-editor.org/rfc/rfc6960) is helpful but not required.
...
2. Clone your fork locally:
    ...
    ```bash
    git clone git@github.com:your-username/laravel-ca-ocsp.git
    cd laravel-ca-ocsp
    ```
...
```
feat: add nonce validation to OCSP request parser
fix: correct DER encoding for revoked certificate status
