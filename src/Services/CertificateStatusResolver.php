...
class CertificateStatusResolver implements CertificateStatusResolverInterface
{
    ...
    public function resolve(
        ...
        try {
            ...
            if ($ca === null) {
                CaLog::ocspResponse($serialNumber, 'unknown', ['reason' => 'ca_not_found']);
            ...
            if ($certificate === null) {
                CaLog::ocspResponse($serialNumber, 'unknown', ['reason' => 'certificate_not_found', 'ca_id' => $ca->id]);
            ...
            if ($certificate->isRevoked()) {
                ...
                CaLog::ocspResponse($serialNumber, 'revoked', [
                    'ca_id' => $ca->id,
                    'revocation_reason' => $revocationReason?->slug,
                ]);
            ...
            if ($certificate->status === CertificateStatus::ACTIVE) {
                CaLog::ocspResponse($serialNumber, 'good', ['ca_id' => $ca->id]);
            ...
            CaLog::ocspResponse($serialNumber, 'unknown', [
                'reason' => 'inactive_certificate',
                'ca_id' => $ca->id,
                'certificate_status' => $certificate->status->value ?? $certificate->status,
            ]);
            ...
            CaLog::critical($e->getMessage(), ['operation' => 'ocsp_response', 'exception' => $e::class]);
